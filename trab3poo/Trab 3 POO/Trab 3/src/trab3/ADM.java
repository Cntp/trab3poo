...
public interface ADM {
	...
	public void Reg_Devolucao(Usuario A, Livro B)throws Exception;//Registra a devolucao do Livro. Tira da lista de emprestimos do usuario. Aplica(Ou nao) a suspensao
	...
	public void Listar_Livros(Livro livro) throws Exception;//Lista todos os livros cadastrados
	public void Listar_Usuarios(Usuario A) throws Exception; //Lista todos os usuarios cadastrados
