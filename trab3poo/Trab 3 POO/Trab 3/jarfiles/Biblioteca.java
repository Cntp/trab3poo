...
public class Biblioteca implements ADM { //esssa classe implementa a interface
	...
	public static void main(String[] args) throws Exception {
		...
		switch(n){
			...
			case 5:
		        ...
		        if(tipoLista == 1){
		        	for(int i =0; i<ind_Usuario; i++) Main.Listar_Usuarios(A[i]);
		...
		CSVWriter wliv = new CSVWriter(new FileWriter(liv));
	...
	@Override
	public void Listar_Usuarios(Usuario A) throws Exception {
		// TODO Auto-generated method stub

		    System.out.println(A.Nome + ", " + A.Tipo);
